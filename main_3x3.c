...
//                printf("%d | %lu\n", cont_Mtx, sign);
                ...
                if(countBitCentrale != -1) { //NUMERO DI OCCORRENZE BIT CENTRALE
                    ...
                    if(
                        //3 VERTICI
                        (mtx[0][0] == mtx[0][2] && mtx[0][0] == mtx[2][2] && mtx[0][0] == mtx[2][0])

                        ||

                        (!(mtx[0][0] == mtx[0][2] && mtx[0][2] == mtx[2][2] && mtx[2][2] == mtx[0][0]) &&
                        !(mtx[0][2] == mtx[2][2] && mtx[2][2] == mtx[2][0] && mtx[2][0] == mtx[0][2]) &&
                        !(mtx[2][2] == mtx[2][0] && mtx[2][0] == mtx[0][0] && mtx[0][0] == mtx[2][2]) &&
                        !(mtx[2][0] == mtx[0][0] && mtx[0][0] == mtx[0][2] && mtx[0][2] == mtx[2][0]) )

                        ||

                        //"L" UNITA
                        (mtx[0][0] == mtx[0][1] && mtx[0][0] == mtx[1][1] && mtx[0][0] == mtx[1][0])

                        ||

                        (!(mtx[0][0] == mtx[0][1] && mtx[0][1] == mtx[1][1] && mtx[1][1] == mtx[0][0]) &&
                        !(mtx[0][1] == mtx[1][1] && mtx[1][1] == mtx[1][0] && mtx[1][0] == mtx[0][1]) &&
                        !(mtx[1][1] == mtx[1][0] && mtx[1][0] == mtx[0][0] && mtx[0][0] == mtx[1][1]) &&
                        !(mtx[1][0] == mtx[0][0] && mtx[0][0] == mtx[0][1] && mtx[0][1] == mtx[1][0]) )

                        ||

                        (mtx[0][1] == mtx[0][2] && mtx[0][1] == mtx[1][2] && mtx[0][1] == mtx[1][1])

                        ||

                        (!(mtx[0][1] == mtx[0][2] && mtx[0][2] == mtx[1][2] && mtx[1][2] == mtx[0][1]) &&
                        !(mtx[0][2] == mtx[1][2] && mtx[1][2] == mtx[1][1] && mtx[1][1] == mtx[0][2]) &&
                        !(mtx[1][2] == mtx[1][1] && mtx[1][1] == mtx[0][1] && mtx[0][1] == mtx[1][2]) &&
                        !(mtx[1][1] == mtx[0][1] && mtx[0][1] == mtx[0][2] && mtx[0][2] == mtx[1][1]) )

                        ||

                        (mtx[1][0] == mtx[1][1] && mtx[1][0] == mtx[2][1] && mtx[1][0] == mtx[2][0])

                        ||

                        (!(mtx[1][0] == mtx[1][1] && mtx[1][1] == mtx[2][1] && mtx[2][1] == mtx[1][0]) &&
                        !(mtx[1][1] == mtx[2][1] && mtx[2][1] == mtx[2][0] && mtx[2][0] == mtx[1][1]) &&
                        !(mtx[2][1] == mtx[2][0] && mtx[2][0] == mtx[1][0] && mtx[1][0] == mtx[2][1]) &&
                        !(mtx[2][0] == mtx[1][0] && mtx[1][0] == mtx[1][1] && mtx[1][1] == mtx[2][0]) )

                        ||

                        (mtx[1][1] == mtx[1][2] && mtx[1][1] == mtx[2][2] && mtx[1][1] == mtx[2][1])

                        ||

                        (!(mtx[1][1] == mtx[1][2] && mtx[1][2] == mtx[2][2] && mtx[2][2] == mtx[1][1]) &&
                        !(mtx[1][2] == mtx[2][2] && mtx[2][2] == mtx[2][1] && mtx[2][1] == mtx[1][2]) &&
                        !(mtx[2][2] == mtx[2][1] && mtx[2][1] == mtx[1][1] && mtx[1][1] == mtx[2][2]) &&
                        !(mtx[2][1] == mtx[1][1] && mtx[1][1] == mtx[1][2] && mtx[1][2] == mtx[2][1]) )

                        ||

                        //"L" STACCATA
                        (mtx[0][0] == mtx[0][1] && mtx[0][0] == mtx[2][0] && mtx[0][0] == mtx[2][1])

                        ||

                        (!(mtx[0][0] == mtx[0][1] && mtx[0][0] == mtx[2][0] && mtx[0][1] == mtx[2][0]) &&
                        !(mtx[0][0] == mtx[0][1] && mtx[0][0] == mtx[2][1] && mtx[0][1] == mtx[2][1]) &&
                        !(mtx[0][1] == mtx[0][2] && mtx[0][1] == mtx[2][1] && mtx[0][2] == mtx[2][1]) &&
                        !(mtx[0][1] == mtx[0][2] && mtx[0][1] == mtx[2][2] && mtx[0][2] == mtx[2][2]) )

                        ||

                        (mtx[0][2] == mtx[1][2] && mtx[0][2] == mtx[1][0] && mtx[0][2] == mtx[0][0])
                        ...
                        (mtx[2][0] == mtx[0][0] && mtx[2][0] == mtx[0][1] && mtx[2][0] == mtx[2][1])

                        ||

                        (!(mtx[2][0] == mtx[2][1] && mtx[2][0] == mtx[0][0] && mtx[2][1] == mtx[0][0]) &&
                        !(mtx[2][0] == mtx[2][1] && mtx[2][0] == mtx[0][1] && mtx[2][1] == mtx[0][1]) &&
                        !(mtx[2][1] == mtx[2][2] && mtx[2][1] == mtx[0][1] && mtx[2][2] == mtx[0][1]) &&
                        !(mtx[2][1] == mtx[2][2] && mtx[2][1] == mtx[0][2] && mtx[2][2] == mtx[0][2]) )

                        ||

                        (mtx[0][0] == mtx[0][2] && mtx[0][0] == mtx[1][0] && mtx[0][0] == mtx[1][2])

                        ||

                        (!(mtx[0][0] == mtx[1][0] && mtx[0][0] == mtx[0][2] && mtx[1][0] == mtx[0][2]) &&
                        !(mtx[0][0] == mtx[1][0] && mtx[0][0] == mtx[1][2] && mtx[1][0] == mtx[1][2]) &&
                        !(mtx[1][0] == mtx[2][0] && mtx[1][0] == mtx[1][2] && mtx[2][0] == mtx[1][2]) &&
...
//                    if(bitCentrale == mtx[0][0]) {
                    ...
                    //PATTERN 3
//                    if(bitCentrale == mtx[1][0] && bitCentrale == mtx[1][2]) {
//                    if(bitCentrale == mtx[0][0] && bitCentrale == mtx[1][2]) {
...
//                            bitCentrale != mtx[2][1] && bitCentrale != mtx[2][0]) &&
