%
% Tesi triennale - modello preso da
...
%			______________                                                %
%                                                                         %
%			AUTORE: Mauro Galimberti                                        %
%                                                                         %
%			Ultima revisione: 1.0.0                                       %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%
...
%
\begin{document}
\title{Funzioni privatamente computabili in logica multivalore}
\author{Mauro GALIMBERTI}
\dept{Corso di Laurea triennale in Sicurezza dei Sistemi e delle Reti Informatiche} 
\anno{2022-2023}
\matricola{943278}
