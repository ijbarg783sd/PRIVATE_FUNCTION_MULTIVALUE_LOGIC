...
void printMtxToFile( int mtx[ NUM ][ NUM ], FILE *fPtr, int cont_Mtx, int mtxType, int *countInterno );
...
//                        printMtxToFile( mtx, logPtr2, cont_Mtx, mtxType, &countInterno2 );
//                    }
                } else if (mtxType == 2) { //MONOCROMATICA 3x3

                    cont_cp++;
                    cont_cp_mono_3x3++;
                    printMtxToFile( mtx, logPtr4, cont_Mtx, mtxType, &countInterno2 );
                } else if (mtxType == 3) { //MONOCROMATICA 2x2

                    cont_cp++;
                    cont_cp_mono_2x2++;
                    printMtxToFile( mtx, logPtr5, cont_Mtx, mtxType, &countInterno2 );
                } else {
...
//                            printMtxToFile( mtx, logPtr3, cont_Mtx, mtxType, &countInterno );
//                        }
                ...
                printMtxToFile( mtx, logPtr1, cont_Mtx, mtxType, &countInterno2 );
